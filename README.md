...
Ячейка 1	Ячейка 2	Ячейка 3
Ячейка 4	Ячейка 5	Ячейка 6
Сравнение Markdown с другими вариантами
Возможность	Markdown	HTML	Plain Text
Простота	Высокая	Средняя	Очень высокая
Форматирование	Хорошее	Отличное	Нет
Работа с кодом	Отличная	Хорошая	Ограниченная
README	Отлично подходит	Подходит	Плохо подходит
---
Список задач
